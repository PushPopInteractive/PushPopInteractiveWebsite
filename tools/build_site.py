...
GAMES = [
    dict(
        ...
        desc=[
            "The simulation found something it can't delete: you. Neonomaly hurls you into the machine itself — every ship, laser, and explosion drawn in searing neon, the grid burning cyan at the surface and bleeding red the deeper you punch through its layers.",
            "Wipe entire squadrons and strip the firepower off their wreckage. Stack it into an arsenal the system was never built to survive. Then dive all the way down to the Core — the machine's beating brain — and overload it until the whole grid goes dark.",
        ],
        shots=[],
    ),
    dict(
        ...
        desc=[
            "Ornithopter is a one-touch flyer set in the world of Returnity. Tap to flap a gold-and-emerald mechanical dragonfly through Greenfield's towers, the Greywake Crypt, the Wetlands, the Great Desert, the lava of the Volcanic Lands and the ice of the Frozen Tundra — every zone drawn in pixel art and followed by its own dungeons, all the way to The Broken Halo.",
            "It is never just pillars. Wraiths chase, orreries spin, lava surges, ceilings crush, gates slam, glowcaps light the dark. Fire a Shield, Steel Form, Triskelion, Greedy Ghost or Rewind Watch from the SKILL button — and stack them. Upgrade the Gold Magnet, unlock new skins, and trade with the Traveling Merchant between zones.",
