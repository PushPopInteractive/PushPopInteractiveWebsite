...
GAMES = [
    ...
    dict(
        ...
        one="Blackjack reimagined as a fantasy battler — commanders, relics, and the bravest question in cards: hit or stand?",
        ...
        desc=[
            ...
            "Build around commander kits with their own styles, stack relics that bend the rules of the table, and manage armor, status effects, and damage-over-time while you decide, again and again, whether to hit or stand.",
        ],
        shots=["splash.jpg"],
    ),
    dict(
    ...
    dict(
        ...
        desc=[
            ...
            "Fight through a 60-level campaign with 11 towers with branching upgrades and gem sockets, 37 enemy types, six-color light zones, and 28 commander loadouts to shape how you hold the line.",
        ],
        shots=[],
    ),
    dict(
